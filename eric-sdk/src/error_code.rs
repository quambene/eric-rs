...
pub enum ErrorCode {
    ...
    /** [610001003] Hinweise während der Plausibilitätsprüfung, Datensatz ist aber plausibel. */
    ...
    /** [610001042] Die übergebene Datenartversion ist unbekannt oder das benötigte ERiC-Plugin wurde nicht gefunden. */
    ERIC_GLOBAL_DATENARTVERSION_UNBEKANNT = 610001042,

    /** [610001044] Die übergebene Datenartversion passt nicht zum Eingangs-XML. */
    ERIC_GLOBAL_DATENARTVERSION_XML_INKONSISTENT = 610001044,

    /** [610001045] Das Plugin 'commonData' konnte nicht geladen werden. */
    ...
    /** [610001051] Das Element "Vorsatz" enthält ungültige Werte. */
    ERIC_GLOBAL_VORSATZ_UNGUELTIG = 610001051,

    /** [610001053] Auf eine Datei konnte nicht in gewünschter Weise zugegriffen werden. */
    ...
    /** [610001083] Der angeforderte ERiC-Instanz konnte nicht erstellt werden. */
    ...
    /** [610001229] Die Versionen der im Logfile genannten ERiC-Dateien sind nicht kompatibel. */
    ...
    /** [610001865] Fehler im übergebenen EDS-XML: In den Sammeldaten wurde ein Nutzdatenticket für mehrere Steuerfälle verwendet. */
    ERIC_GLOBAL_NUTZDATENTICKETS_NICHT_EINDEUTIG = 610001865,

    /** [610001866] Fehler im übergebenen EDS-XML: Bei den Sammeldaten wurden unterschiedliche Versionen des Nutzdaten-Headers verwendet. */
    ERIC_GLOBAL_NUTZDATENHEADERVERSIONEN_UNEINHEITLICH = 610001866,

    /** [610001867] Fehler im übergebenen EDS-XML: Es wurden Fälle für mehrere Bundesländer angegeben. */
    ERIC_GLOBAL_BUNDESLAENDER_UNEINHEITLICH = 610001867,

    /** [610001868] Fehler im übergebenen EDS-XML: Es wurden Fälle für unterschiedliche Jahre angegeben. */
    ...
    /** [610101210] Fehler im Transferheader. Der ELSTER-Annahmeserver hat einen Fehler zurückgemeldet. */
    ...
    /** [610101282] Fehler bei der Initialisierung des Versands. */
    ...
    /** [610101292] Fehler im NutzdatenHeader. Der ELSTER-Annahmeserver hat einen Fehler zurückgemeldet. */
    ...
    /** [610101500] Es konnte kein Ad Hoc-Zertifikat fuer den Personalausweis oder den Aufenthaltstitel erzeugt bzw. gefunden werden. */
    ...
    /** [610101520] Der eID-Client ist nicht erreichbar. */
    ERIC_TRANSFER_EID_KEINCLIENT = 610101520,

    /** [610101521] Der eID-Client hat einen Fehler gemeldet. */
    ERIC_TRANSFER_EID_CLIENTFEHLER = 610101521,

    /** [610101522] Es konnten nicht alle benötigten Datenfelder des Personalausweises ausgelesen werden. */
    ...
    /** [610101524] Der Personalausweis wird von einem anderen Vorgang blockiert. */
    ...
    /** [610201213] Das übergebene Zertifikat weist Inkonsistenzen auf. */
    ...
    /** [610301106] Es wurden unerwartete Elemente in der Eingabedatei gefunden. */
    ERIC_IO_READER_UNERWARTETE_ELEMENTE = 610301106,

    /** [610301107] Es wurden formale Fehler in der Eingabedatei gefunden. */
    ERIC_IO_READER_FORMALE_FEHLER = 610301107,

    /** [610301108] Die Eingabedaten lagen nicht im Encoding UTF-8 ohne BOM vor. */
    ...
    /** [610301170] Es wurden Fehler in den Angaben zur Referenzierung von Belegen (RABE) gefunden. */
    ERIC_IO_READER_RABE_FEHLER = 610301170,

    /** [610301171] Es wurde keine RabeId angegeben. */
    ERIC_IO_READER_KEINE_RABEID = 610301171,

    /** [610301172] Es wurde eine ungültige RabeId gefunden. */
    ERIC_IO_READER_RABEID_UNGUELTIG = 610301172,

    /** [610301173] Es wurde eine ungültige VerifikationsId gefunden. */
    ERIC_IO_READER_RABE_VERIFIKATIONSID_UNGUELTIG = 610301173,

    /** [610301174] Es wurde eine ungültige ReferenzId gefunden. */
    ERIC_IO_READER_RABE_REFERENZID_UNGUELTIG = 610301174,

    /** [610301175] Es wurde eine ReferenzId für ein Feld angegeben, das keine ReferenzId erlaubt. */
    ERIC_IO_READER_RABE_REFERENZID_NICHT_ERLAUBT = 610301175,

    /** [610301176] Für einen Nutzdatenblock wurde mehrfach die gleiche ReferenzId angegeben. */
    ERIC_IO_READER_RABE_REFERENZIDS_NICHT_EINDEUTIG = 610301176,

    /** [610301190] Ein Nutzdatenblock enthält zu viele Anhänge. */
    ERIC_IO_READER_ZU_VIELE_ANHAENGE = 610301190,

    /** [610301191] Ein Anhang ist zu groß. */
    ERIC_IO_READER_ANHANG_ZU_GROSS = 610301191,

    /** [610301192] Die Gesamtgröße aller Anhänge in einem Nutzdatenblock ist zu groß. */
    ERIC_IO_READER_ANHAENGE_ZU_GROSS = 610301192,

    /** [610301193] Der referenzierte Anhang ist zu klein und muss in das XML eingebettet werden. */
    ERIC_IO_READER_ANHANG_ZU_KLEIN = 610301193,

    /** [610301200] Es traten Fehler beim Validieren des XML auf. */
    ...
    /** [610301202] Die im XML angegebene Hersteller-ID ist gesperrt. */
    ...
    /** [610501002] Keine Druckvorlage für die angegebene Kombination aus Unterfallart und Veranlagungszeitraum gefunden. */
    ...
    /** [610501007] ERiCPrint wurde nicht richtig initialisiert. */
    ...
    /** [610501009] Der Beginn des Ausdruckprozesses schlug fehl. */
